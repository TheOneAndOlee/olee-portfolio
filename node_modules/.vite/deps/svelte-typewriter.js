import {
  concurrent_default
} from "./chunk-2UTLFG6M.js";
import {
  cascade_default
} from "./chunk-YQHYOGME.js";
import {
  loop_default
} from "./chunk-UAZPBSNU.js";
import {
  loopOnce_default
} from "./chunk-GO3XRSFL.js";
import {
  loopRandom_default
} from "./chunk-O3GCZCBR.js";
import "./chunk-7FGJKF5E.js";
import "./chunk-RQUA6DAP.js";
import "./chunk-6EDVRSUZ.js";
import {
  scramble_default
} from "./chunk-E7TTGGTC.js";
import "./chunk-IZY6TQ5J.js";
import {
  __extends,
  __spreadArray,
  init_tslib_es6,
  tslib_es6_exports
} from "./chunk-FD65SJWE.js";
import "./chunk-KKJPXILQ.js";
...
var init_lib = __esm({
  "node_modules/@formatjs/fast-memoize/lib/index.js"() {
    ...
    (function() {
      ...
      ObjectWithoutPrototypeCache2.prototype.get = function(key2) {
        return this.cache[key2];
      };
      ObjectWithoutPrototypeCache2.prototype.set = function(key2, value) {
...
function HasOwnProperty(o, prop2) {
  return Object.prototype.hasOwnProperty.call(o, prop2);
}
function Type(x) {
  if (x === null) {
    return "Null";
...
function GetOption(opts, prop2, type, values, fallback) {
  if (typeof opts !== "object") {
    throw new TypeError("Options must be an object");
  }
  var value = opts[prop2];
  if (value !== void 0) {
...
function GetStringOrBooleanOption(opts, prop2, values, trueValue, falsyValue, fallback) {
  var value = opts[prop2];
  if (value === void 0) {
    return fallback;
  }
  ...
  if (!PROCESSED_DATA) {
    ...
    PROCESSED_DATA = {
      ...
      matchVariables: matchVariables.reduce(function(all, d) {
        var key2 = Object.keys(d)[0];
        var value = d[key2];
        all[key2.slice(1)] = value._value.split("+");
        return all;
      }, {}),
...
function InsertUnicodeExtensionAndCanonicalize(locale, attributes, keywords) {
  ...
  for (var _a = 0, keywords_1 = keywords; _a < keywords_1.length; _a++) {
    ...
    var key2 = kw.key, value = kw.value;
    extension += "-".concat(key2);
    if (value !== "") {
...
function ResolveLocale(availableLocales, requestedLocales, options, relevantExtensionKeys, localeData, getDefaultLocale) {
  ...
  var _loop_1 = function(key3) {
    var keyLocaleData = (_a = foundLocaleData === null || foundLocaleData === void 0 ? void 0 : foundLocaleData[key3]) !== null && _a !== void 0 ? _a : [];
    invariant2(Array.isArray(keyLocaleData), "keyLocaleData for ".concat(key3, " must be an array"));
  ...
  for (var _i = 0, relevantExtensionKeys_1 = relevantExtensionKeys; _i < relevantExtensionKeys_1.length; _i++) {
    var key2 = relevantExtensionKeys_1[_i];
    _loop_1(key2);
  }
  ...
  "node_modules/@formatjs/intl-segmenter/src/segmenter.js"(exports) {
    ...
    var Segmenter = (
      ...
      (function() {
        ...
        Segmenter2.availableLocales = new Set(Object.keys(cldr_segmentation_rules_generated_1.SegmentationRules).filter(function(key2) {
          return key2 !== "root";
        }));
    ...
    function getSlot(instance, key2) {
      return (0, ecma402_abstract_1.getInternalSlot)(__INTERNAL_SLOT_MAP__, instance, key2);
    }
    function setSlot(instance, key2, value) {
      (0, ecma402_abstract_1.setInternalSlot)(__INTERNAL_SLOT_MAP__, instance, key2, value);
    }
...
var $$css = {
  hash: "s-2T4i7Kdb9jsZ",
  code: "\n	@keyframes s-2T4i7Kdb9jsZ-cursorFade {\n		0%,\n		100% {\n			opacity: 1;\n		}\n\n		50% {\n			opacity: 0;\n		}\n	}\n\n	.typewriter-container.s-2T4i7Kdb9jsZ *:not(.typing):not(.finished-typing):not([data-static]) {\n		display: none;\n	}\n\n	.typewriter-container.s-2T4i7Kdb9jsZ .finished-typing::after {\n		content: none;\n	}\n\n    .cursor.s-2T4i7Kdb9jsZ .typing::after {\n        content: '';\n        width: var(--cursor-width, 1ch);\n        height: 2ch;\n        display: inline-block;\n        vertical-align: text-top;\n        background-color: var(--cursor-color, #000000);\n        animation: s-2T4i7Kdb9jsZ-cursorFade 1.25s infinite;\n    }\n\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */"
};
function Typewriter($$anchor, $$props) {
  ...
  const modes = {
    concurrent: () => import("./concurrent-LM6HJ4OF.js"),
    cascade: () => import("./cascade-QNULCVPF.js"),
    loop: () => import("./loop-VIPVKEYI.js"),
    loopOnce: () => import("./loopOnce-KUNCVLH3.js"),
    loopRandom: () => import("./loopRandom-XCC3RIXP.js"),
    scramble: () => import("./scramble-BYMWDIQP.js")
  };
